#西瓜书 1.2题，方法思路与前两种一样，都是先遍历所有可能性再去重（去冗余）优点在于使用了18位二进制来代表不同的可能性，但是缺点依然存在，循环数量级当k=8时已经是亿级，当k=15时会达到万亿次循环，算不出来的
#转载于 @是你的小鱼 https://blog.csdn.net/yuzeyuan12/article/details/83113461
#python
import numpy as np
